...
$sourceFiles = @('Models.cs','RegionManagement.cs','LauncherRegion.cs','LaunchEngine.cs','WindowsPlatform.cs','Program.cs','LauncherWindow.cs','AssemblyInfo.cs') | ForEach-Object { Join-Path $PSScriptRoot $_ }
