...
$sources = @('Models.cs','RegionManagement.cs','LauncherRegion.cs','LaunchEngine.cs','WindowsPlatform.cs','Program.cs','LauncherWindow.cs','Tests\EngineTests.cs','Tests\RegionTests.cs') | ForEach-Object { Join-Path $PSScriptRoot $_ }
